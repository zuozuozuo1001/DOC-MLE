...
path_piexllabel_images_drive = './dataset1/xirou_5_5/training/pixellabel/images/'
path_piexllabel_gt_drive = './dataset1/xirou_5_5/training/pixellabel/1st_manual/'
path_unlabel_images_drive = './dataset1/xirou_5_5/training/unlabel/images/'
path_unlabel_gt_drive = './dataset1/xirou_5_5/training/unlabel/1st_manual/'
path_images_test_drive = './dataset1/xirou_5_5/test/images/'
path_gt_test_drive = './dataset1/xirou_5_5/test/1st_manual/'
...
def save_drive_data(mum_arg = 1):
    images_piexllabel, mask_piexllabel= data_for_train(10, mum_arg, 300, 300,
                                  path_piexllabel_images_drive, path_piexllabel_gt_drive, 50, mask_ch=1, augu=True)

    images_unlabel, mask_unlabel = data_for_train(10, mum_arg, 300, 300,
                                    path_unlabel_images_drive, path_unlabel_gt_drive, 50, mask_ch=1, augu=True)

    images_test, mask_test = data_for_train(0, mum_arg, 300, 300,
                                  path_images_test_drive, path_gt_test_drive, 34, mask_ch=1, augu=False)
